...
public class ConsultaItensPlanoMestre {
	...
	public int getQtdeDemAcumProg() {
		return qtdeDemAcumProg;
	}
	public void setQtdeDemAcumProg(int qtdeDemAcumProg) {
		this.qtdeDemAcumProg = qtdeDemAcumProg;
	}
	public int getQtdeProcAcumProg() {
		return qtdeProcAcumProg;
	}
	public void setQtdeProcAcumProg(int qtdeProcAcumProg) {
		this.qtdeProcAcumProg = qtdeProcAcumProg;
	}
	public int getQtdeSaldoAcumProg() {
		return qtdeSaldoAcumProg;
	}
	public void setQtdeSaldoAcumProg(int qtdeSaldoAcumProg) {
		this.qtdeSaldoAcumProg = qtdeSaldoAcumProg;
	}
