...
public class TarefasController {
	...
	public Tarefas saveTarefas(@RequestBody BodyTarefas body) {
		return tarefasService.saveTarefas(body.id, body.anexo, body.assunto, body.origem, body.sistema, body.situacao, body.tempoEstimado, body.titulo, body.usuarioAtribuido, body.usuarioSolicitante, body.dataPrevista, body.numDocInterno, body.numDocFornecedor);
	}
