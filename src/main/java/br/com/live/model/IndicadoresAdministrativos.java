...
public class IndicadoresAdministrativos {
	...
	public IndicadoresAdministrativos() {
		
	}
	
	public IndicadoresAdministrativos(long id, String nomeIndicador, int grupoIndicador, int area, int departamento, int setor,
			int gestorAvaliado, String unidadeMedida, String frequenciaMonitoramento, String fonteDados,
			String polaridade, int responsavelRegistro, int responsavelPublicacao, String observacao,
			String formulaCalculo, String variaveis) {
		this.id = id;
		this.nomeIndicador = nomeIndicador;
		this.grupoIndicador = grupoIndicador;
		this.area = area;
