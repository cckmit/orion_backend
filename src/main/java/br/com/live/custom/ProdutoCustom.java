...
public class ProdutoCustom {
	...
	public Produto findProduto(String nivel, String grupo, String sub, String item) {
		...
		String query = " select a.nivel_estrutura nivel, a.grupo_estrutura grupo, a.subgru_estrutura sub, a.item_estrutura item, a.narrativa, b.unidade_medida unidade, c.ordem_tamanho seqTamanho" 
