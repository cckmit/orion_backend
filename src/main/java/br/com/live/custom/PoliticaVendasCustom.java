...
public class PoliticaVendasCustom {
	...
	public List<DivergenciasPoliticaVendas> findDivergencias() {
		String query = "SELECT REGRAS.PEDIDO CODPEDIDO, "
				...
				+ " REGRAS.DIVERGENCIA "
				+ " FROM ( "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DIVERGÊNCIA: FORMA DE PAGTO INCORRETA!' DIVERGENCIA "
				+ " FROM pedi_100 a, orion_com_260 b "
				...
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DIVERGÊNCIA: CNPJ X Codigo Funcionário!' DIVERGENCIA "
				+ " FROM pedi_100 a, orion_com_260 b "
				+ " WHERE a.cod_cancelamento = 0 "
				+ " AND a.situacao_venda <> 10 "
				...
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DIVERGÊNCIA: CNPJ X Desconto Capa' DIVERGENCIA "
				+ " FROM pedi_100 a, orion_com_260 b "
				+ " WHERE a.cod_cancelamento = 0 "
				+ " AND a.situacao_venda <> 10 "
				+ " AND b.cnpj9 = a.cli_ped_cgc_cli9 "
				...
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DIVERGÊNCIA: Desconto Máx. X Comissão' DIVERGENCIA "
				+ " FROM pedi_100 a, orion_com_260 b "
				+ " WHERE a.cod_cancelamento = 0 "
				+ "  AND a.situacao_venda  <> 10 "
				...
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DIVERGÊNCIA: Portador x Forma de Pagamento x Condição de Pagamento' DIVERGENCIA "
				+ " FROM pedi_100 a, orion_com_260 b "
				+ " WHERE a.cod_cancelamento = 0 "
				+ "  AND a.situacao_venda  <> 10 "
				+ "  AND b.forma_pagamento = a.cod_forma_pagto "
				...
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DIVERGÊNCIA: Franchising x Natureza Operação x Desconto' DIVERGENCIA "
				+ " FROM pedi_100 a, orion_com_260 b "
				+ " WHERE a.cod_cancelamento = 0 "
				+ "  AND a.situacao_venda  <> 10 "
				+ "  AND b.cnpj9 = a.cli_ped_cgc_cli9 "
				...
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DIVERGÊNCIA: Cond De Pagamento x Desconto x Natureza x Forma de Pagamento' DIVERGENCIA "
				+ " FROM pedi_100 a, orion_com_260 b "
				+ " WHERE a.cod_cancelamento = 0 "
				+ "  AND a.situacao_venda  <> 10 "
				...
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DIVERGÊNCIA: CNPJ X Codigo Funcionario X Natureza Operação X Portador X Condição Pagamento' DIVERGENCIA "
				+ " FROM pedi_100 a, orion_com_260 b "
				+ " WHERE a.cod_cancelamento = 0 "
				+ "  AND a.situacao_venda  <> 10 "
				+ "  AND b.cnpj9 = a.cli_ped_cgc_cli9 "
				...
				+ "                  AND c.cond_pgto = a.cond_pgto_venda)"
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM DEPÓSITOS DIFERENTE NOS ITENS' DIVERGENCIA "
				+ " FROM pedi_100 a "
				...
				+ " UNION "
				+ " SELECT a.pedido_venda PEDIDO, a.data_entr_venda DATA_EMBARQUE, a.data_emis_venda DATA_EMISSAO, 'PEDIDO: ' || a.pedido_venda || ' COM LOTE DE ITENS DIFERENTE DE 0' DIVERGENCIA "
				+ " FROM pedi_100 a "
				+ " WHERE a.situacao_venda <> 10 "
				+ "  AND a.cod_cancelamento = 0 "
				+ "  AND EXISTS (SELECT 1 FROM pedi_110 b "
