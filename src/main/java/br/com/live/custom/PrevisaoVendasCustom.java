...
public class PrevisaoVendasCustom {
	...
	public List<ConsultaPrevisaoVendasItem> findPrevisaoVendasItensByIdPrevisaoVendaColecao(long idPrevisaoVendas,
		...
		String query = " select rownum id, produtos.grupo, produtos.item, produtos.descricao, "
				...
				+ " linha.linha_produto || '-' || linha.descricao_linha linha, " + " produtos.embarque, "
				...
				+ " nvl(previsao_item.grupo_base,'') grupoBase, " + " nvl(previsao_item.item_base,'') itemBase, "
				...
				+ " from basi_030 a, basi_010 b " + " where a.nivel_estrutura = '1' " + " and a.colecao = " + colecao
				+ " and b.nivel_estrutura = a.nivel_estrutura " + " and b.grupo_estrutura = a.referencia "
				+ " group by a.referencia, a.linha_produto, a.artigo, b.item_estrutura " + " union "
				...
				+ " from basi_030 a, basi_010 b " + " where a.nivel_estrutura = '1' "
				+ " and a.colecao in (select c.colecao from basi_140 c "
				+ " where c.descricao_espanhol like '%COLECAO PERMANENTE%') "
				+ " and b.nivel_estrutura = a.nivel_estrutura " + " and b.grupo_estrutura = a.referencia "
				+ " and exists (select 1 from basi_632 c " + " where c.cd_agrupador = " + colecao
				+ " and c.grupo_ref = b.grupo_estrutura " + " and c.item_ref = b.item_estrutura) "
				...
				+ " and previsao_item.grupo (+) = produtos.grupo " + " and previsao_item.item (+) = produtos.item "
				+ " and artigo.artigo = produtos.artigo " + " and linha.linha_produto = produtos.linha ";
