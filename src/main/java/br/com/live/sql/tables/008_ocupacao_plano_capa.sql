...
(id varchar2(20), -- num_plano_mestre - estagio   
 ...
 perc_ocupacao_pecas number(9,3),
 qtde_falta_sobra_pecas number(9),

 qtde_capacidade_minutos number(9),
 qtde_plano_minutos number(9),
 qtde_programado_minutos number(9), 
 perc_ocupacao_minutos number(9,3),
 qtde_falta_sobra_minutos number(9),
...
create INDEX INDX_ORION_25_PLANO_MESTRE on orion_021 (num_plano_mestre);
create INDEX INDX_ORION_25_PLANO_ESTAGIO on orion_021 (num_plano_mestre, estagio);
