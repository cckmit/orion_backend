...
insert into mqop_160 (select m.codigo_operacao codigo, 'MICROMOVIMENTO GENERICO' descricao, 0 utiliza_maquina, m.tempo_homem tempo, 1 frequencia, 1 quantidade from mqop_040 m);

-- atualizar mqop_045
insert into mqop_045 (select m.codigo_operacao, m.codigo_operacao codigo_movimento, 1 sequencia, 1 quantidade, 1 frequencia, m.tempo_homem tempo_total  from mqop_040 m);
