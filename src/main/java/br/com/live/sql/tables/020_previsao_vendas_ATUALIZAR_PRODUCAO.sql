...
(id varchar2(30), -- idPrevisao - Referência - Cor 999999999-99999-999999
 ...
 constraint fk_orion_041_orion_040	foreign key (num_id_previsao_vendas) references orion_040 (id)
); 

comment on table orion_041 is 'Tabela de previsão de vendas - itens';

create INDEX INDX_ORION_41_PREV_VENDAS on orion_041 (num_id_previsao_vendas);
