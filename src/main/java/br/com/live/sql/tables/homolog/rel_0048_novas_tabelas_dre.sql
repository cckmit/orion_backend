...
-- ORÇAMENTO LOJAS – DRE
    ...
    CREATE TABLE ORION_FIN_015 (
        ...
        VAL_PROP_JAN NUMBER(12,3),
        VAL_PROP_FEV NUMBER(12,3),
        VAL_PROP_MAR NUMBER(12,3),
        VAL_PROP_ABR NUMBER(12,3),
        VAL_PROP_MAI NUMBER(12,3),
        VAL_PROP_JUN NUMBER(12,3),
        VAL_PROP_JUL NUMBER(12,3),
        VAL_PROP_AGO NUMBER(12,3),
        VAL_PROP_SET NUMBER(12,3),
        VAL_PROP_OUT NUMBER(12,3),
        VAL_PROP_NOV NUMBER(12,3),
        VAL_PROP_DEZ NUMBER(12,3),
        CONSTRAINT PK_ORION_FIN_015 PRIMARY KEY (CNPJ_LOJA, ANO_ORCAMENTO, TIPO_ORCAMENTO, PROPRIEDADE)
    );
...
-- GERAR DRE DAS LOJAS
    ...
    CREATE TABLE ORION_FIN_030 (
      ...
      CONSTRAINT ORION_FIN_030 PRIMARY KEY (CNPJ_LOJA, ANO_DRE, MES_DRE, PROPRIEDADE)
    );