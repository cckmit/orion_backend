...
from (select a.cd_it_pe_nivel99 nivel, a.cd_it_pe_grupo grupo, a.cd_it_pe_subgrupo sub, a.cd_it_pe_item item,
       ...
       p.pedido_venda pedido, c.codigo_cliente embarque, p.situacao_venda
from pedi_100 p, pedi_110 a, basi_030 b, basi_010 c
...
select a.item_nivel99 nivel, a.item_grupo grupo, a.item_sub sub, a.item_item item,
       ...
       i.pedido_venda pedido, d.codigo_cliente embarque, 0 situacao_venda
from inte_100 i, inte_110 a, basi_030 b, pcpc_010 c, basi_010 d
