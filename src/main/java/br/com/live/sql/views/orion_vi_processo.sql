...
select rownum id, a.proconf_nivel99 nivel, a.proconf_grupo grupo, a.proconf_subgrupo sub, a.proconf_item item,
       ...
       c.colecao, c.conta_estoque, c.linha_produto, c.artigo, c.artigo_cotas, d.origem_prod origem, o.permanente, d.codigo_cliente embarque
from pcpc_040 a, pcpc_020 b, basi_030 c, basi_010 d, orion_vi_produtos o
...
group by rownum, a.proconf_nivel99, a.proconf_grupo, a.proconf_subgrupo, a.proconf_item, b.periodo_producao,
         c.colecao, c.conta_estoque, c.linha_produto, c.artigo, c.artigo_cotas, d.origem_prod, o.permanente, d.codigo_cliente
