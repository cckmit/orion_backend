...
@Entity
@Table(name="orion_ind_090")
public class IndicadoresDiario {
    ...
    public IndicadoresDiario() {
    	
    }

	public IndicadoresDiario(int idIndicador, String variaveis, String mes, int ano, String codigo, String descricao, float dia1, float dia2, float dia3, float dia4, float dia5, float dia6, 
