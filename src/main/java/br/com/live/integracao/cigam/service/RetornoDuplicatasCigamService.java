...
import br.com.live.integracao.cigam.model.ListaRetornoApiDuplicatas;
import br.com.live.integracao.cigam.model.ParametrosRetorno;
import br.com.live.integracao.cigam.model.RetornoApiDuplicatas;
...
@Service
public class RetornoDuplicatasCigamService {
    ...
    public RetornoDuplicatasCigamService(IntegracaoCigamCustom integracaoCigamCustom) {
        this.integracaoCigamCustom = integracaoCigamCustom;
    }

    public void gravarDadosRetornoDuplicatas() {
        ...
        try {
            System.out.println("-----------------------------------");
            System.out.println("INICIANDO GRAVAÇÃO DAS DUPLICATAS");

            String url = API_ENDPOINT_RETORNO + "?guid=CIGAM_DUPLICATAS";
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                RetornoApiDuplicatas retornoDuplicatas = objectMapper.readValue(responseBody,
                        new TypeReference<RetornoApiDuplicatas>() {
                        });

                for (ListaRetornoApiDuplicatas dadosRetorno : retornoDuplicatas.dados) {
                    integracaoCigamCustom.inserirDadosDuplicatas(dadosRetorno);
                }
            } else {
        ...
        System.out.println("FIM DA INTEGRAÇÃO DAS DUPLICATAS");
    }
}
