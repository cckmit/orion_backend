...
import br.com.live.integracao.cigam.model.ListaRetornoApiClienteFornecedor;
import br.com.live.integracao.cigam.model.ParametrosRetorno;
import br.com.live.integracao.cigam.model.RetornoApiClienteFornecedor;
...
@Service
public class RetornoClienteFornecedorCigamService {
    ...
    public RetornoClienteFornecedorCigamService(IntegracaoCigamCustom integracaoCigamCustom) {
        this.integracaoCigamCustom = integracaoCigamCustom;
    }

    public void gravarDadosRetornoClienteFornecedor() {
        ...
        try {
            System.out.println("-----------------------------------");
            System.out.println("INICIANDO GRAVAÇÃO DOS CLIENTES");

            String url = API_ENDPOINT_RETORNO + "?guid=CIGAM_CLIENTEFORNECEDOR";
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                RetornoApiClienteFornecedor retornoCliFor = objectMapper.readValue(responseBody,
                        new TypeReference<RetornoApiClienteFornecedor>() {
                        });

                for (ListaRetornoApiClienteFornecedor dadosRetorno : retornoCliFor.dados) {
                    integracaoCigamCustom.inserirDadosClienteFornecedor(dadosRetorno);
                }
            } else {
        ...
        System.out.println("FIM DA INTEGRAÇÃO DOS CLIENTES");
    }
}
