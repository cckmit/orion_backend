...
import br.com.live.integracao.cigam.model.ListaRetornoApiEstoque;
import br.com.live.integracao.cigam.model.ParametrosRetorno;
import br.com.live.integracao.cigam.model.RetornoApiEstoque;
...
@Service
public class RetornoEstoqueCigamService {
    ...
    public RetornoEstoqueCigamService(IntegracaoCigamCustom integracaoCigamCustom) {
        this.integracaoCigamCustom = integracaoCigamCustom;
    }

    public void gravarDadosRetornoEstoque() {
        try {
            System.out.println("-----------------------------------");
            System.out.println("INICIANDO GRAVAÇÃO DOS ESTOQUES");

            String url = API_ENDPOINT_RETORNO + "?guid=CIGAM_ESTOQUE";

            ParametrosRetorno dado = new ParametrosRetorno();
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                for (ListaRetornoApiEstoque dadosRetorno : retornoEstoques.dados) {
                    integracaoCigamCustom.inserirDadosEstoque(dadosRetorno);
                }
            } else {
        ...
        System.out.println("FIM DA INTEGRAÇÃO DOS ESTOQUES");
    }
}
