...
/*
  ...
  CLASSE DESCONTINUADA - DEVERÁ SER ELIMINADA DEPOIS DA ENTREGA DO PROJETO.
...
@Service
@Transactional
public class SugestaoReservaTecidoPorPreOrdensService {
	...
	public SugestaoReservaTecidoPorPreOrdensService(PlanoMestreCustom planoMestreCustom, ProdutoCustom produtoCustom, 
	...
	private SugestaoReservaTecidos obterDadosSugestaoReserva() {
		...
		return null ; //new SugestaoReservaTecidos(listaPriorizadaPreOrdens, listaSugestaoPorOrdens, listaSugestaoPorProdutos, listaSugestaoPorTecidos, listaItensComQtdesAtendidas);
	}
